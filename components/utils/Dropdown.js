...
const Dropdown = ({ main, options }) => {
	...
	return (
		<div onMouseOver={() => setdrop(false)}>
			<div className="relative inline-block text-left">
				<div>
					<button
						type="button"
						className="text-black hover:bg-gray-50 text-[16px] border-b border-gray-100 md:hover:bg-transparent md:border-0 pl-3 pr-4 py-2 md:p-0 font-medium flex items-center justify-between w-full md:w-auto"
						id="menu-button"
						aria-expanded="true"
						aria-haspopup="true"
					>
